...
const dorms = {
  ...
  'zhixin': {
    ...
    title: 'title_zhixin',
    content: '知行苑(1-6，15,16)：位于中心食堂附近的1、5、6栋是学校现存最老的寝室，每层楼设有公用的卫生间、洗澡间。15、16栋寝室则在太极运动场旁边，楼下是商店和快递点，附近有红高粱和兴业苑食堂。1、5、6栋寝室为4人间，每层楼设有卫生间和阳台。15、16栋则为标准的6人间，上床下桌，配有阳台，独立卫生间。'
  },
  'minli': {
    photoIndex: 0,
    photos: [
